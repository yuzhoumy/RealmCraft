...
public class ResourceStorm extends StrategicEvent implements Listener {
    ...
    public void onMenuClick(Player player) {
        if (System.currentTimeMillis() < cooldown && !plugin.getNewbieQuestManager().getNewbieQuests().get(16).isQuestRunning(player)) { //quest 17
